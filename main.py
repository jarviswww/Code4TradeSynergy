...
parser.add_argument('--scale', type=float, default=0.2, help='the sacle of ICLoss')
...
parser.add_argument('--slack', type=int, default=0, help='slack or not')
parser.add_argument('--threshold', type=int, default=8, help='number of fixed sampling')
